package in.appmaster.grpc.stub;
...
public final class HelloServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<in.appmaster.grpc.stub.HelloRequest,
      in.appmaster.grpc.stub.HelloResponse> METHOD_HELLO =
      io.grpc.MethodDescriptor.<in.appmaster.grpc.stub.HelloRequest, in.appmaster.grpc.stub.HelloResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "HelloService", "hello"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              in.appmaster.grpc.stub.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              in.appmaster.grpc.stub.HelloResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(in.appmaster.grpc.stub.HelloRequest request,
        io.grpc.stub.StreamObserver<in.appmaster.grpc.stub.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                in.appmaster.grpc.stub.HelloRequest,
                in.appmaster.grpc.stub.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public in.appmaster.grpc.stub.HelloResponse hello(in.appmaster.grpc.stub.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<in.appmaster.grpc.stub.HelloResponse> hello(
        in.appmaster.grpc.stub.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((in.appmaster.grpc.stub.HelloRequest) request,
              (io.grpc.stub.StreamObserver<in.appmaster.grpc.stub.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static final class HelloServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return in.appmaster.grpc.stub.HelloServiceOuterClass.getDescriptor();
    }
  }
